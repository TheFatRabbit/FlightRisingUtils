...
top_left_point = (22/70 * screen_width + config["screen_bbox"][0], 21/100 * screen_height + config["screen_bbox"][1])
top_left_point_diagonal = (7/20 * screen_width + config["screen_bbox"][0], 91/600 * screen_height + config["screen_bbox"][1])
top_left_point_vertical = (11/35 * screen_width + config["screen_bbox"][0], 137/600 * screen_height + config["screen_bbox"][1])
top_right_point = (243/350 * screen_width + config["screen_bbox"][0], 21/100 * screen_height + config["screen_bbox"][1])
...
# REPLACE THIS WITH HOWEVER THE THING WORKS
